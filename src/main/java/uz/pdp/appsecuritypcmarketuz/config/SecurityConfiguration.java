package uz.pdp.appsecuritypcmarketuz.config;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
//                .antMatchers(HttpMethod.GET,"/api/brand/**").hasAnyRole("SUPER_ADMIN","MODERATOR","OPERATOR")
//                .antMatchers("/api/brand").hasAnyRole("SUPER_ADMIN","MODERATOR")
